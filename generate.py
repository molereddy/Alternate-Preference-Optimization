...
def get_model(config):
    ...
    if config['model_name'] == "tofu_ft_llama2-7b":
...
def get_prompts(config):
    ...
    if config['prompt_name'] == 'INST_QAS_TEMPLATE':
        from prompts import INST_QAS_TEMPLATE, INST_QAS_TEMPLATE_QUERY
        ...
        from prompts import INST_QAS_LLAMA3_TEMPLATE, INST_QAS_LLAMA3_TEMPLATE_QUERY
